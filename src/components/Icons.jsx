...
export var GithubIcon = function(props) {
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-hidden="true" style={{ flexShrink: 0 }} {...props}>
...
export var LinkedinIcon = function(props) {
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-hidden="true" style={{ flexShrink: 0 }} {...props}>
